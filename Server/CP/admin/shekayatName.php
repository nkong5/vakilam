...
<div class="backnew4">
  ...
  <div class="adcomment" align="center">'.xss($rows["datamind2"]).'</div>
    ...
    <div class="oprate" align="center">
         ...
         <a href="dataedit/shekayatNameEdit.php?id='.xss($rows["id"]).'&datamind2='.xss($rows["datamind2"]).'" class="aaa"><div class="click3">درج توضیحات</div></a>
