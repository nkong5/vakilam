...
<div class="divi">
    ...
    <div class="rtl">
        <a href="../plusshek/plusedit13.php" ><div class="oprate24" align="center">نمونه شکایت به سازمان بازرسی کل کشور</div> </a>
        <div class="backnew11">
    ...
    <div class="rtl">
        <?php
        $sql="select * from shekayatname WHERE dataid2 = 13";
