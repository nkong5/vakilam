...
<div class="posi chap">
        <br>
        <form action="accAdmin14.php" method="post" name="sample-legal-complaint-14" id="sample-legal-complaint-14" class=" chap"  dir="rtl">
            <input type="hidden" name="csrf_token" value="<?php echo generateToken('sample-legal-complaint-14'); ?>"/>
    ...
    <a href="../sheknamepage/shekayatName14.php"><button class="oonvar">بازگشت</button></a>
</div>
