...
<div class="posi chap">
        <br>
        <form action="accAdmin15.php" method="post" name="sample-legal-complaint-15" id="sample-legal-complaint-15" class=" chap"  dir="rtl">
            <input type="hidden" name="csrf_token" value="<?php echo generateToken('sample-legal-complaint-15'); ?>"/>
    ...
    <a href="../sheknamepage/shekayatName15.php"><button class="oonvar">بازگشت</button></a>
</div>
