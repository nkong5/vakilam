...
<div class="posi chap">
        <br>
        <form action="accAdmin11.php" method="post" name="sample-legal-complaint-11" id="sample-legal-complaint-11" class=" chap"  dir="rtl">
            <input type="hidden" name="csrf_token" value="<?php echo generateToken('sample-legal-complaint-11'); ?>"/>
    ...
    <a href="../sheknamepage/shekayatName11.php"><button class="oonvar">بازگشت</button></a>
</div>
